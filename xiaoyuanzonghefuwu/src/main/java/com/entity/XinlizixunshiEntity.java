...
public class XinlizixunshiEntity<T> implements Serializable {
     ...
     * 职业
     */
    @TableField(value = "xinlizixunshi_zhiye")

    private String xinlizixunshiZhiye;
	 ...
	 * 设置：职业
	 */
    public String getXinlizixunshiZhiye() {
        return xinlizixunshiZhiye;
    }
    /**
	 * 获取：职业
	 */

    public void setXinlizixunshiZhiye(String xinlizixunshiZhiye) {
        this.xinlizixunshiZhiye = xinlizixunshiZhiye;
    }
    /**
	 * 设置：电子邮箱
	 */
    ...
    public String toString() {
        return "Xinlizixunshi{" +
            ...
            ", xinlizixunshiZhiye=" + xinlizixunshiZhiye +
