...
public class ChatController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        logger.debug("page 方法:,,Controller:{},,params:{}",this.getClass().getName(),JSONObject.toJSONString(params));
    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(chat !=null){
            ...
            BeanUtils.copyProperties( chat , view );//把实体数据重构到 view 中
    ...
    */
    ...
    public R update(@RequestBody ChatEntity chat, HttpServletRequest request){
        logger.debug("update 方法:,,Controller:{},,chat:{}",this.getClass().getName(),chat.toString());

        // 直接根据 id 更新，不检查重复
        chatService.updateById(chat);//根据 id 更新
        return R.ok();
    }
    ...
    */
    ...
    public R save( String fileName, HttpServletRequest request){
        logger.debug("batchInsert 方法:,,Controller:{},,fileName:{}",this.getClass().getName(),fileName);
        ...
        try {
            ...
            if(lastIndexOf == -1){
                ...
                if(!".xls".equals(suffix)){
                    return R.error(511,"只支持后缀为 xls 的 excel 文件");
                }else{
                    ...
                    if(!file.exists()){
                        ...
                        List<List<String>> dataList = PoiUtil.poiImport(file.getPath());//读取 xls 文件
...
//                            chatEntity.setInsertTime(date);//时间
    ...
    */
    ...
    public R list(@RequestParam Map<String, Object> params, HttpServletRequest request){
        logger.debug("list 方法:,,Controller:{},,params:{}",this.getClass().getName(),JSONObject.toJSONString(params));
    ...
    */
    ...
    public R detail(@PathVariable("id") Long id, HttpServletRequest request){
        logger.debug("detail 方法:,,Controller:{},,id:{}",this.getClass().getName(),id);
        ChatEntity chat = chatService.selectById(id);
            if(chat !=null){
                ...
                //级联表
                    YonghuEntity yonghu = yonghuService.selectById(chat.getYonghuId());
                if(yonghu != null){
                    BeanUtils.copyProperties( yonghu , view ,new String[]{ "id", "createDate"});//把级联的数据添加到 view 中，并排除 id 和创建时间字段
                    view.setYonghuId(yonghu.getId());
                }
                //修改对应字典表字段
                dictionaryService.dictionaryConvert(view, request);
    ...
    */
    ...
    public R add(@RequestBody ChatEntity chat, HttpServletRequest request){
        logger.debug("add 方法:,,Controller:{},,chat:{}",this.getClass().getName(),chat.toString());
