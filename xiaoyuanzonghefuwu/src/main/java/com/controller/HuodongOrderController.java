...
public class HuodongOrderController {
    ...
    */
    ...
    public R save(@RequestBody HuodongOrderEntity huodongOrder, HttpServletRequest request){
        ...
        if(huodongOrder.getYonghuId() == null){
        ...
        HuodongOrderEntity existOrder = huodongOrderService.selectOne(
            new EntityWrapper<HuodongOrderEntity>()
                .eq("huodong_id", huodongOrder.getHuodongId())
                .eq("yonghu_id", huodongOrder.getYonghuId())
        );
        if(existOrder != null){
    ...
    */
    ...
    public R add(@RequestBody HuodongOrderEntity huodongOrder, HttpServletRequest request){
        ...
        if("用户".equals(role)){
            ...
            if(userId != null){
                huodongOrder.setYonghuId(Integer.valueOf(String.valueOf(userId)));
            }
        }
        if(huodongOrder.getHuodongId() == null){
            return R.error("活动不能为空");
        ...
        HuodongOrderEntity huodongOrderEntity = huodongOrderService.selectOne(
            new EntityWrapper<HuodongOrderEntity>()
                .eq("huodong_id", huodongOrder.getHuodongId())
                .eq("yonghu_id", huodongOrder.getYonghuId())
        );
        ...
        huodongOrder.setInsertTime(new Date());
        huodongOrder.setCreateTime(new Date());
        huodongOrderService.insert(huodongOrder);//新增报名
        return R.ok();
    }
