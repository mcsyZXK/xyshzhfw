...
//                            xinlizixunshiEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        // 将用户信息存入 Session
        request.getSession().setAttribute("userId", xinlizixunshi.getId());
        request.getSession().setAttribute("role", "心里咨询师");
        request.getSession().setAttribute("tableName", "xinlizixunshi");
        request.getSession().setAttribute("username", xinlizixunshi.getXinlizixunshiName());
